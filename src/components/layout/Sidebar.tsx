    ...
    <aside className="hidden md:flex w-60 shrink-0 flex-col border-r border-border bg-surface">
      <div className="flex items-center gap-2 px-5 py-5 border-b border-border">
        ...
        <div className="leading-tight">
          <p className="text-sm font-semibold text-slate-100">SSB Screening</p>
          <p className="text-xs text-slate-400">Border Checkpoint Unit</p>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-border">
        <div className="rounded-md bg-surface-raised px-3 py-2.5">
          ...
          <div className="mt-1 flex items-center gap-1.5">
            ...
            <p className="text-xs font-medium text-slate-200">Online &middot; Lane 3</p>
          </div>
        </div>
      </div>
    </aside>
